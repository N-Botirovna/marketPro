...
const BookDetails = ({ bookId }) => {
  ...
  const getCoverTypeLabel = (coverType) => {
    switch (coverType) {
      case 'hard': return 'Qattiq muqova';
      case 'soft': return 'Yumshoq muqova';
  ...
  if (error) {
    return (
      <section className='py-80'>
        <div className='container container-lg'>
          <div className='text-center'>
            <p className='text-danger'>Kitob tafsilotlari yuklashda xatolik yuz berdi</p>
          </div>
        </div>
      </section>
    );
          ...
          <div className='col-lg-6'>
            <div className='product-details__content'>
              ...
              <div className='mb-16'>
                ...
                <span className='fw-medium'>{book.author || 'Noma\'lum muallif'}</span>
              </div>
              ...
              {book.script_type && (
                <div className='mb-16'>
                  ...
                  <span className='fw-medium'>{getScriptTypeLabel(book.script_type)}</span>
                </div>
              )}
              ...
              {book.cover_type && (
                <div className='mb-16'>
                  ...
                  <span className='fw-medium'>{getCoverTypeLabel(book.cover_type)}</span>
                </div>
              )}
            ...
            <div className='border border-gray-100 rounded-16 p-32'>
              ...
              <div className='row'>
                <div className='col-md-6'>
                  ...
                  <div className='mb-16'>
                    <strong>Holati:</strong> {book.is_used ? 'Ishlatilgan' : 'Yangi'}
                  </div>
                  <div className='mb-16'>
                  ...
                  {book.script_type && (
                    <div className='mb-16'>
                      <strong>Yozuv turi:</strong> {getScriptTypeLabel(book.script_type)}
                    </div>
                  )}
                </div>
                <div className='col-md-6'>
                  {book.cover_type && (
                    <div className='mb-16'>
                      <strong>Muqova:</strong> {getCoverTypeLabel(book.cover_type)}
                    </div>
                  )}
                  {book.publication_year && (
                    <div className='mb-16'>
                  ...
                  <div className='mb-16'>
                    <strong>Yaratilgan sana:</strong> {new Date(book.created_at).toLocaleDateString('uz-UZ')}
                  </div>
                </div>
              </div>
            </div>
