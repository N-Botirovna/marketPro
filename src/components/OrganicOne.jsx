      ...
      <div className='container container-lg'>
        <div className='section-heading'>
          <div className='flex-between flex-wrap gap-8'>
            <h5 className='mb-0'>Yangi kitoblar</h5>
            <p>Eng so'nggi qo'shilgan kitoblar</p>
        ...
        <div className='organic-food__slider arrow-style-two'>
          <Slider {...settings}>
            {Array.isArray(books) && books.length > 0 ? (
              books.map((item) => {
                const imgSrc = item?.picture || 'assets/images/thumbs/product-img20.png';
                const title = item?.name || 'Unknown title';
                const shopName = item?.shop?.name || 'Unknown shop';
                const hasDiscount = !!item?.discount_price;
                const priceCurrent = item?.discount_price || item?.price || '';
                const priceOld = hasDiscount ? item?.price : '';
              ...
              <>
                ...
                {/* existing static slides continue here */}
              </>
            )}
          </Slider>
        </div>
