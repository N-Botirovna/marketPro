                    ...
                    {isLoggedIn ? (
                      <div>
                        ...
                        <button
                          ...
                          className='common-dropdown__link nav-submenu__link hover-bg-neutral-100 w-100 text-start border-0 bg-transparent'
                        >
                          Logout
                        </button>
                      </div>
                    ...
                    <ul className='on-hover-dropdown common-dropdown common-dropdown--sm max-h-200 scroll-sm px-0 py-8'>
                      ...
                      <li className='nav-submenu__item'>
                        <button
                          ...
                          className='nav-submenu__link hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex-align gap-8 rounded-0 w-100 text-start border-0 bg-transparent'
                        >
                          <span className='text-sm d-flex'>
